...
<html>
<head>
    <title>Formulation - Financial 1</title>
</head>
<body>
<div class="main-content container-fluid">
    ...
    <div class="row">
        <div class="col-md-8 form-group">
            <div class="btn-group dropdown mb-1">
                ...
                <div class="dropdown-menu" aria-labelledby="ddown">
                    <ul class="list-unstyled moreStatusUl"></ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-1 form-group">
            <div class="btn-group dropdown mb-1 pull-right chooseActionBtn">
                <button type="button" class="btn btn-info btn-sm square dropdown-toggle dropdown-toggle-split"
    ...
    <div class="card">
        <div class="card-content">
            <input type="hidden" id="yearHidden" class="yearId" autocomplete="off">
            <input type="hidden" id="companyIdHidden" autocomplete="off">
                            ...
                            <div class="card-body accordoin-body">
                                <div class="editMode hidden">
                                    <form id="targetForm" class="targetForm"
                                        ...
                                        <input type="hidden" value="${targetId}" id="targetId" name="targetId"
                                               autocomplete="off">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label for="year"
                                            ...
                                            <div class="col-md-6 form-group">
                                                <form:select class="form-select square cursor-pointer"
                                                             path="companyList" id="companyId" name="companyId"
                                                             required="required">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="number" id="preYearTarget"
                                                       class="form-control square field"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                <input type="number" id="curYearBudget"
                                                       class="form-control square field"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <small class="pull-right cursor-pointer editModeAttachment"
                                                       data-bs-toggle="modal" data-bs-target="#attachmentModal"
                                                       title="Click to view"></small>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-3">
                                                <label for="curYearDhiProposal" class="col-form-label pull-right">
                                                    DHI's Proposal for <span class="curYearDhiCurYearProLbl"></span>
                                                </label>
                                            </div>
                                            <div class="col-md-2 form-group">
                                                <input type="number" id="curYearDhiProposal"
                                                       class="form-control square field" name="curYearDhiProposal"
                                                       autocomplete="off">
                                            ...
                                            <c:choose>
                                                ...
                                                <span title="Click to edit"
                                                      class="badge bg-info square cursor-pointer btnReviewerRemark btnRemarkModal"
                                                      data-bs-toggle="modal" data-bs-target="#remarkModalEditMode">
                                                    Reviewer's Remark
                                                </span>
                                                    </div>
                                                </c:when>
                                        ...
                                        <c:when test="${myRoleId!=creatorRoleId}">
                                            <div style="text-align: center;vertical-align: middle;position: relative;">
                                                <span title="Click to view"
                                                      class="badge bg-info square cursor-pointer btnReviewerRemark btnReadRemarkModal"
                                                      data-bs-toggle="modal" data-bs-target="#remarkModalDisplayMode">
                                                    Reviewer's Remark
                                                </span>
                                            </div>
                                        </c:when>
                                ...
                                <div class="editMode hidden">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 form-group">
                                            <div class="form-check form-check-success">
                                                <input type="radio" class="form-check-input cursor-pointer"
                                                       name="evalFormula" id="formulaTypeOther" value="3">
                                                <label class="form-check-label cursor-pointer" for="formulaTypeOther"
                                                       style="text-transform: capitalize;">
                                                    Others
                                                </label>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="fileListDiv">
                    <ul class="list-unstyled project_files fileUl"></ul>
                </div>
            </div>
...
<div class="modal fade" id="attachmentModalDisplay" tabindex="-1" role="dialog" data-bs-backdrop="static"
     aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title attachmentModalTitle"><i class="fa fa-paperclip"></i>Attachment List</h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                </button>
            </div>
    ...
    <div class="card square" style="border: 1px solid #528cfa;">
        <div class="card-body pt-2">
            ...
            <div class="card-content">
                ...
                <div class="form-group">
                    <span class="badge bg-info cursor-pointer btnCommentPolicy shake animated" data-bs-toggle="modal"
