...
<html>
<head>
    <title>Formulation - Production/Sales/Projects 2</title>
</head>
<body>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Production/Sales/Prpjects
                            ...
                            <div class="card-body accordoin-body">
                                <form id="targetForm" class="targetForm"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <label for="particular" class="col-form-label required pull-right">
                                                Particular</label>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <textarea id="particular" class="form-control square field"
                                                      name="particular" autocomplete="off" required
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2 form-group">
                                                        <input type="text" id="uom" class="form-control square field"
                                                               name="subTargetDtos[0].uom" required autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <label for="preYearActual"
                                                               class="col-form-label required pull-right">
                                                    ...
                                                    <div class="col-md-2 form-group">
                                                        <input type="number" id="preYearActual"
                                                               ...
                                                               name="subTargetDtos[0].preYearActual" required
                                                               autocomplete="off">
                                                    </div>

                                                    <div class="col-md-2">
                                                        <label for="preYearTarget"
                                                               class="col-form-label required pull-right">
                                                    ...
                                                    <div class="col-md-2 form-group">
                                                        <input type="number" id="preYearTarget"
                                                               class="form-control square field"
                                                               name="subTargetDtos[0].preYearTarget" required
                                                               autocomplete="off">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="curYearTarget"
                                                               class="col-form-label required pull-right">
                                                            <span class="curYearTargetLbl"></span> Target
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2 form-group">
                                                        <input type="number" id="curYearTarget"
                                                               class="form-control square field"
                                                               name="subTargetDtos[0].curYearTarget" required
                                                               autocomplete="off">
                                                    </div>
                                                </div>
                                                <div class="row">
                                            ...
                                            <textarea id="explanation" class="form-control square field"
                                                      name="subTargetDtos[0].explanation" autocomplete="off"
                                                      onkeyup="textAreaAdjust(this)"></textarea>
                                                    </div>
                                                </div>
                                            </td>
