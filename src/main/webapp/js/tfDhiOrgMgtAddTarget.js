tfDhiOrgMgtAddTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfDhiOrgMgtAddTarget/';
    }
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
        tfDhiOrgMgtAddTarget.getPreData();
        tfDhiOrgMgtAddTarget.autoSuggest();
        tfDhiOrgMgtAddTarget.initEditor();
        tfDhiOrgMgtAddTarget.initialSetup();
        tfDhiOrgMgtAddTarget.onChangeYearAndCompany();
        tfDhiOrgMgtAddTarget.toggleLabel(year);
        tfDhiOrgMgtAddTarget.addTarget();
        tfDhiOrgMgtAddTarget.getAllocatedWt(year, companyId);
        tfDhiOrgMgtAddTarget.btnAddMore();
        tfDhiOrgMgtAddTarget.deleteSubTarget();
        tfDhiOrgMgtAddTarget.btnGoBack();
    });
