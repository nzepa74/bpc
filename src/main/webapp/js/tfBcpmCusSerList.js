tfBcpmCusSerList = (function () {
    "use strict";
    let form = $('#targetListForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfBcpmCusSerList/';
    }
    ...
    function navigateToTfBcpmCusSerAddTarget() {
        $('.btnAddNewTarget').on('click', function () {
            let year = $('#year').val();
            let companyId = $('#companyId').val();
            window.location.href = 'tfBcpmCusSerAddTarget?yId=' + year + '&&cId=' + companyId
        });
    }
    ...
    function navigateToEditTarget() {
        $('#targetListTable tbody').on('click', 'tr .activity', function () {
            ...
            window.location.href = 'tfBcpmCusSerEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
        });
    }
    ...
    function getComment() {
        $('#targetListTable tbody').on('click', 'tr .btnViewComment', function () {
            ...
            $('.targetNameDisplay').empty().html('<strong>' + targetName + ' </strong>');
            $.ajax({
                url: 'api/tfBcpmCusSerEditTarget/getCusSerComment',
                type: 'GET',
    ...
    function getAttachment() {
        $('#targetListTable tbody').on('click', 'tr .btnAttachment', function () {
            ...
            $.ajax({
                url: 'api/tfBcpmCusSerEditTarget/getAttachments',
                type: "GET",
    ...
    function viewFile() {
        $('.fileListDiv ul').on('click', 'li .viewFile', function () {
            ...
            let url = 'api/tfBcpmCusSerEditTarget/viewFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    function downloadFile() {
        $('.fileListDiv ul').on('click', 'li span.fileName', function () {
            let fileId = $(this).closest('.fileUl .fileLi').find('.fileId').val();
            let url = 'api/tfBcpmCusSerEditTarget/downloadFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    return {
        ...
        , navigateToTfBcpmCusSerAddTarget: navigateToTfBcpmCusSerAddTarget
        , btnSearch: btnSearch
...
$(document).ready(
    function () {
        tfBcpmCusSerList.triggerSearch();
        tfBcpmCusSerList.navigateToTfBcpmCusSerAddTarget();
        tfBcpmCusSerList.btnSearch();
        tfBcpmCusSerList.searchByStage();
        tfBcpmCusSerList.navigateToEditTarget();
        tfBcpmCusSerList.getWriteup();
        tfBcpmCusSerList.getComment();
        tfBcpmCusSerList.getAttachment();
        tfBcpmCusSerList.viewFile();
        tfBcpmCusSerList.downloadFile();
        tfBcpmCusSerList.submit();
        tfBcpmCusSerList.revert();
        tfBcpmCusSerList.approve();
        tfBcpmCusSerList.btnGoBack();
    });
