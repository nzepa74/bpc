tfBcpmOrgMgtEditTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    ...
    function _baseURL() {
        return 'api/tfBcpmOrgMgtEditTarget/';
    }
    ...
    function checkPermission(year, companyId, statusFlag) {
        ...
        $.ajax({
            url: 'api/tfBcpmOrgMgtList/checkPermission',
            type: 'GET',
    ...
    function getPreData() {
        ...
        $.ajax({
            url: "api/tfBcpmOrgMgtAddTarget/getTargetActivity",
            type: 'GET',
            success: function (res) {
                for (let i in res) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res.status === 1) {
                                            ...
                                            let targetId = $('#targetId').val();
                                            let newUrlIS = window.location.origin + '/tfBcpmOrgMgtEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
    ...
    function getAllocatedWt(year, companyId) {
        $.ajax({
            url: 'api/tfBcpmOrgMgtAddTarget/getAllocatedWt',
            type: "GET",
            data: {year: year, companyId: companyId},
            success: function (res) {
                if (res.status === 1) {
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
         tfBcpmOrgMgtEditTarget.initEditor();
        tfBcpmOrgMgtEditTarget.getTarget();
        tfBcpmOrgMgtEditTarget.getPreData();
        tfBcpmOrgMgtEditTarget.autoSuggest();
        tfBcpmOrgMgtEditTarget.toggleLabel(year);
        tfBcpmOrgMgtEditTarget.actionBtnEdit();
        tfBcpmOrgMgtEditTarget.editTarget();
        tfBcpmOrgMgtEditTarget.getAllocatedWt(year, companyId);
        tfBcpmOrgMgtEditTarget.getAttachments();
        tfBcpmOrgMgtEditTarget.deleteFile();
        tfBcpmOrgMgtEditTarget.viewFile();
        tfBcpmOrgMgtEditTarget.downloadFile();
        tfBcpmOrgMgtEditTarget.remarkModalEditMode();
        tfBcpmOrgMgtEditTarget.remarkModalDisplayMode();
        tfBcpmOrgMgtEditTarget.addRemark();
        tfBcpmOrgMgtEditTarget.editRemark();
        tfBcpmOrgMgtEditTarget.addComment();
        tfBcpmOrgMgtEditTarget.getComment();
        tfBcpmOrgMgtEditTarget.closeOrReopenTarget();
        tfBcpmOrgMgtEditTarget.btnAddMore();
        tfBcpmOrgMgtEditTarget.deleteSubTarget();
        tfBcpmOrgMgtEditTarget.deleteTarget();
        tfBcpmOrgMgtEditTarget.getEditHistoryDetail();
        tfBcpmOrgMgtEditTarget.checkCommentPolicy();
        tfBcpmOrgMgtEditTarget.getCommentPolicy();
        tfBcpmOrgMgtEditTarget.btnGoBack();
    });
