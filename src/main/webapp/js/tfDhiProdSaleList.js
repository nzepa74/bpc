tfDhiProdSaleList = (function () {
    "use strict";
    let form = $('#targetListForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfDhiProdSaleList/';
    }
    ...
    function navigateToTfDhiProdSaleAddTarget() {
        $('.btnAddNewTarget').on('click', function () {
            let year = $('#year').val();
            let companyId = $('#companyId').val();
            window.location.href = 'tfDhiProdSaleAddTarget?yId=' + year + '&&cId=' + companyId
        });
    }
            ...
            success: function (res) {
                if (res.status === 1) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        let curYearDhiProposal = data[i].curYearDhiProposal;
                        ...
                        childRow = childRow + '<tr>' +
                            ...
                            '<td>' + curYearTarget + '</td>' +
                            '<td>' + weightage + '</td>' +
                            '<td>' + isNull(curYearDhiProposal) + '</td>' +
                            '<td>' + attachment + '</td>' +
                            '</tr>';
                    }
    ...
    function toggleTheadLbl(year) {
        ...
        $('.curYearDhiProposalLbl').text(year);
    }
    ...
    function navigateToEditTarget() {
        $('#targetListTable tbody').on('click', 'tr .particular', function () {
            ...
            window.location.href = 'tfDhiProdSaleEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
        });
    }
    ...
    function getComment() {
        $('#targetListTable tbody').on('click', 'tr .btnViewComment', function () {
            ...
            $('.targetNameDisplay').empty().html('<strong>' + targetName + ' </strong>');
            $.ajax({
                url: 'api/tfDhiProdSaleEditTarget/getProdSaleComment',
                type: 'GET',
    ...
    function getAttachment() {
        $('#targetListTable tbody').on('click', 'tr .btnAttachment', function () {
            ...
            $.ajax({
                url: 'api/tfDhiProdSaleEditTarget/getAttachments',
                type: "GET",
    ...
    function viewFile() {
        $('.fileListDiv ul').on('click', 'li .viewFile', function () {
            ...
            let url = 'api/tfDhiProdSaleEditTarget/viewFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    function downloadFile() {
        $('.fileListDiv ul').on('click', 'li span.fileName', function () {
            let fileId = $(this).closest('.fileUl .fileLi').find('.fileId').val();
            let url = 'api/tfDhiProdSaleEditTarget/downloadFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    return {
        ...
        , navigateToTfDhiProdSaleAddTarget: navigateToTfDhiProdSaleAddTarget
        , btnSearch: btnSearch
...
$(document).ready(
    function () {
        tfDhiProdSaleList.triggerSearch();
        tfDhiProdSaleList.navigateToTfDhiProdSaleAddTarget();
        tfDhiProdSaleList.btnSearch();
        tfDhiProdSaleList.searchByStage();
        tfDhiProdSaleList.navigateToEditTarget();
        tfDhiProdSaleList.getWriteup();
        tfDhiProdSaleList.getComment();
        tfDhiProdSaleList.getAttachment();
        tfDhiProdSaleList.viewFile();
        tfDhiProdSaleList.downloadFile();
        tfDhiProdSaleList.submit();
        tfDhiProdSaleList.revert();
        tfDhiProdSaleList.approve();
        tfDhiProdSaleList.btnGoBack();
    });
