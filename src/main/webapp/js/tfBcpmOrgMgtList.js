tfBcpmOrgMgtList = (function () {
    "use strict";
    let form = $('#targetListForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfBcpmOrgMgtList/';
    }
    ...
    function navigateToTfBcpmOrgMgtAddTarget() {
        $('.btnAddNewTarget').on('click', function () {
            let year = $('#year').val();
            let companyId = $('#companyId').val();
            window.location.href = 'tfBcpmOrgMgtAddTarget?yId=' + year + '&&cId=' + companyId
        });
    }
    ...
    function navigateToEditTarget() {
        $('#targetListTable tbody').on('click', 'tr .activity', function () {
            ...
            window.location.href = 'tfBcpmOrgMgtEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
        });
    }
    ...
    function getComment() {
        $('#targetListTable tbody').on('click', 'tr .btnViewComment', function () {
            ...
            $('.targetNameDisplay').empty().html('<strong>' + targetName + ' </strong>');
            $.ajax({
                url: 'api/tfBcpmOrgMgtEditTarget/getOrgMgtComment',
                type: 'GET',
    ...
    function getAttachment() {
        $('#targetListTable tbody').on('click', 'tr .btnAttachment', function () {
            ...
            $.ajax({
                url: 'api/tfBcpmOrgMgtEditTarget/getAttachments',
                type: "GET",
    ...
    function viewFile() {
        $('.fileListDiv ul').on('click', 'li .viewFile', function () {
            ...
            let url = 'api/tfBcpmOrgMgtEditTarget/viewFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    function downloadFile() {
        $('.fileListDiv ul').on('click', 'li span.fileName', function () {
            let fileId = $(this).closest('.fileUl .fileLi').find('.fileId').val();
            let url = 'api/tfBcpmOrgMgtEditTarget/downloadFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    return {
        ...
        , navigateToTfBcpmOrgMgtAddTarget: navigateToTfBcpmOrgMgtAddTarget
        , btnSearch: btnSearch
...
$(document).ready(
    function () {
        tfBcpmOrgMgtList.triggerSearch();
        tfBcpmOrgMgtList.navigateToTfBcpmOrgMgtAddTarget();
        tfBcpmOrgMgtList.btnSearch();
        tfBcpmOrgMgtList.searchByStage();
        tfBcpmOrgMgtList.navigateToEditTarget();
        tfBcpmOrgMgtList.getWriteup();
        tfBcpmOrgMgtList.getComment();
        tfBcpmOrgMgtList.getAttachment();
        tfBcpmOrgMgtList.viewFile();
        tfBcpmOrgMgtList.downloadFile();
        tfBcpmOrgMgtList.submit();
        tfBcpmOrgMgtList.revert();
        tfBcpmOrgMgtList.approve();
        tfBcpmOrgMgtList.btnGoBack();
    });
