tfDhiProdSaleEditTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    ...
    function _baseURL() {
        return 'api/tfDhiProdSaleEditTarget/';
    }
            ...
            success: function (res) {
                if (res.status === 1) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        let myRoleId = $('#myRoleId').val();
                        let creatorRoleId = $('#creatorRoleId').val();
                        let curYearDhiProposalInput = '<input type="number" readonly id="curYearDhiProposal' + i + '" class="form-control square field" value="' + data[i].curYearDhiProposal + '" name="subTargetDtos[0].curYearDhiProposal" autocomplete="off">';
                        ...
                        if (myRoleId !== creatorRoleId) {
                            ...
                            curYearDhiProposalInput = '<input type="number" id="curYearDhiProposal' + i + '" class="form-control square field" value="' + data[i].curYearDhiProposal + '" name="subTargetDtos[0].curYearDhiProposal" autocomplete="off">';
                        }
                        displayModeSubTarget = '<div class="row">' +
                            ...
                            '<div class="col-md-4">' + curYear + ' DHI Proposal:<strong> ' + isNull(data[i].curYearDhiProposal) + '</strong></div>' +
                        ...
                        let editMode = '<tr><td>' +
                            ...
                            '<div class="row">' +
                            '<div class="col-md-2">' +
                            '<label for="curYearDhiProposal' + i + '" class="col-form-label pull-right">' + curYear + ' DHI Proposal</label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group">' + curYearDhiProposalInput +
                            '</div>' +
                            '<div class="col-md-2 form-group">' +
    ...
    function checkPermission(year, companyId, statusFlag) {
        ...
        $.ajax({
            url: 'api/tfDhiProdSaleList/checkPermission',
            type: 'GET',
                ...
                if (res.status === 1) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        displayModeSubTarget = displayModeSubTarget +
                            ...
                            '<div class="col-md-4"><span>' + curYear + ' DHI Proposal:</span> <strong>' + isNull(data[i].curYearDhiProposal) + '</strong></div>' +
                            '</div>' +
                            '<div class="row">' +
    ...
    function getPreData() {
        ...
        $.ajax({
            url: "api/tfDhiProdSaleAddTarget/getTargetActivity",
            type: 'GET',
            success: function (res) {
                for (let i in res) {
    ...
    function btnAddMore() {
        $('.btnAddMore').on('click', function () {
            ...
            let myRoleId = $('#myRoleId').val();
            let creatorRoleId = $('#creatorRoleId').val();
            let curYearDhiProposalInput = '<input type="number" readonly id="curYearDhiProposal' + dynamicId + '" class="form-control square field"  name="subTargetDtos[0].curYearDhiProposal" autocomplete="off">';
            if (myRoleId.toString() !== creatorRoleId.toString()) {
                curYearDhiProposalInput = '<input type="number" id="curYearDhiProposal' + dynamicId + '" class="form-control square field" name="subTargetDtos[0].curYearDhiProposal" autocomplete="off">';
            }
            let subTarget = '<tr><td>' +
                '<div class="row">' +
                '<div class="col-md-2">' +
                ...
                '<div class="row">' +
                '<div class="col-md-2">' +
                '<label for="curYearDhiProposal' + dynamicId + '" class="col-form-label pull-right">' + curYear + ' DHI Proposal</label>' +
                '</div>' +
                '<div class="col-md-2 form-group">' + curYearDhiProposalInput + '</div>' +
                '<div class="col-md-2 form-group">' +
                '<button type="button" class="btn btn-danger btn-s square btnDeleteSubTarget"><i class="fa fa-trash"></i> Delete this target</button>' +
                '</div>' +
                '</div>' +
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res.status === 1) {
                                            ...
                                            let targetId = $('#targetId').val();
                                            let newUrlIS = window.location.origin + '/tfDhiProdSaleEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
    ...
    function getAllocatedWt(year, companyId) {
        $.ajax({
            url: 'api/tfDhiProdSaleAddTarget/getAllocatedWt',
            type: "GET",
            data: {year: year, companyId: companyId},
            success: function (res) {
                if (res.status === 1) {
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
         tfDhiProdSaleEditTarget.initEditor();
        tfDhiProdSaleEditTarget.getTarget();
        tfDhiProdSaleEditTarget.getPreData();
        tfDhiProdSaleEditTarget.autoSuggest();
        tfDhiProdSaleEditTarget.toggleLabel(year);
        tfDhiProdSaleEditTarget.actionBtnEdit();
        tfDhiProdSaleEditTarget.editTarget();
        tfDhiProdSaleEditTarget.getAllocatedWt(year, companyId);
        tfDhiProdSaleEditTarget.getAttachments();
        tfDhiProdSaleEditTarget.deleteFile();
        tfDhiProdSaleEditTarget.viewFile();
        tfDhiProdSaleEditTarget.downloadFile();
        tfDhiProdSaleEditTarget.remarkModalEditMode();
        tfDhiProdSaleEditTarget.remarkModalDisplayMode();
        tfDhiProdSaleEditTarget.addRemark();
        tfDhiProdSaleEditTarget.editRemark();
        tfDhiProdSaleEditTarget.addComment();
        tfDhiProdSaleEditTarget.getComment();
        tfDhiProdSaleEditTarget.closeOrReopenTarget();
        tfDhiProdSaleEditTarget.btnAddMore();
        tfDhiProdSaleEditTarget.deleteSubTarget();
        tfDhiProdSaleEditTarget.deleteTarget();
        tfDhiProdSaleEditTarget.getEditHistoryDetail();
        tfDhiProdSaleEditTarget.checkCommentPolicy();
        tfDhiProdSaleEditTarget.getCommentPolicy();
        tfDhiProdSaleEditTarget.btnGoBack();
    });
