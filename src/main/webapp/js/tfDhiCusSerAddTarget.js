tfDhiCusSerAddTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfDhiCusSerAddTarget/';
    }
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
        tfDhiCusSerAddTarget.getPreData();
        tfDhiCusSerAddTarget.autoSuggest();
        tfDhiCusSerAddTarget.initEditor();
        tfDhiCusSerAddTarget.initialSetup();
        tfDhiCusSerAddTarget.onChangeYearAndCompany();
        tfDhiCusSerAddTarget.toggleLabel(year);
        tfDhiCusSerAddTarget.addTarget();
        tfDhiCusSerAddTarget.getAllocatedWt(year, companyId);
        tfDhiCusSerAddTarget.btnAddMore();
        tfDhiCusSerAddTarget.deleteSubTarget();
        tfDhiCusSerAddTarget.btnGoBack();
    });
