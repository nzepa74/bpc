tfDhiProdSaleAddTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfDhiProdSaleAddTarget/';
    }
    let configEditor = {
        fontNames: ['Garamond'],
...
$(document).ready(
    function () {
        let year = $('#yearHidden').val();
        let companyId = $('#companyIdHidden').val();
        tfDhiProdSaleAddTarget.getPreData();
        tfDhiProdSaleAddTarget.autoSuggest();
        tfDhiProdSaleAddTarget.initEditor();
        tfDhiProdSaleAddTarget.initialSetup();
        tfDhiProdSaleAddTarget.onChangeYearAndCompany();
        tfDhiProdSaleAddTarget.toggleLabel(year);
        tfDhiProdSaleAddTarget.addTarget();
        tfDhiProdSaleAddTarget.getAllocatedWt(year, companyId);
        tfDhiProdSaleAddTarget.btnAddMore();
        tfDhiProdSaleAddTarget.deleteSubTarget();
        tfDhiProdSaleAddTarget.btnGoBack();
    });
