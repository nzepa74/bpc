tfDhiOrgMgtEditTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    ...
    function _baseURL() {
        return 'api/tfDhiOrgMgtEditTarget/';
    }
    ...
    function checkPermission(year, companyId, statusFlag) {
        ...
        $.ajax({
            url: 'api/tfDhiOrgMgtList/checkPermission',
            type: 'GET',
    ...
    function getPreData() {
        ...
        $.ajax({
            url: "api/tfDhiOrgMgtAddTarget/getTargetActivity",
            type: 'GET',
            success: function (res) {
                for (let i in res) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res.status === 1) {
                                            ...
                                            let targetId = $('#targetId').val();
                                            let newUrlIS = window.location.origin + '/tfDhiOrgMgtEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
    ...
    function getAllocatedWt(year, companyId) {
        $.ajax({
            url: 'api/tfDhiOrgMgtAddTarget/getAllocatedWt',
            type: "GET",
            data: {year: year, companyId: companyId},
            success: function (res) {
                if (res.status === 1) {
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
         tfDhiOrgMgtEditTarget.initEditor();
        tfDhiOrgMgtEditTarget.getTarget();
        tfDhiOrgMgtEditTarget.getPreData();
        tfDhiOrgMgtEditTarget.autoSuggest();
        tfDhiOrgMgtEditTarget.toggleLabel(year);
        tfDhiOrgMgtEditTarget.actionBtnEdit();
        tfDhiOrgMgtEditTarget.editTarget();
        tfDhiOrgMgtEditTarget.getAllocatedWt(year, companyId);
        tfDhiOrgMgtEditTarget.getAttachments();
        tfDhiOrgMgtEditTarget.deleteFile();
        tfDhiOrgMgtEditTarget.viewFile();
        tfDhiOrgMgtEditTarget.downloadFile();
        tfDhiOrgMgtEditTarget.remarkModalEditMode();
        tfDhiOrgMgtEditTarget.remarkModalDisplayMode();
        tfDhiOrgMgtEditTarget.addRemark();
        tfDhiOrgMgtEditTarget.editRemark();
        tfDhiOrgMgtEditTarget.addComment();
        tfDhiOrgMgtEditTarget.getComment();
        tfDhiOrgMgtEditTarget.closeOrReopenTarget();
        tfDhiOrgMgtEditTarget.btnAddMore();
        tfDhiOrgMgtEditTarget.deleteSubTarget();
        tfDhiOrgMgtEditTarget.deleteTarget();
        tfDhiOrgMgtEditTarget.getEditHistoryDetail();
        tfDhiOrgMgtEditTarget.checkCommentPolicy();
        tfDhiOrgMgtEditTarget.getCommentPolicy();
        tfDhiOrgMgtEditTarget.btnGoBack();
    });
