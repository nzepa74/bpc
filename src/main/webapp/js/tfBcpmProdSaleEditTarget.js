tfBcpmProdSaleEditTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    ...
    function _baseURL() {
        return 'api/tfBcpmProdSaleEditTarget/';
    }
            ...
            success: function (res) {
                if (res.status === 1) {
                    ...
                    if ((myRoleId.toString() !== reviewerRoleId.toString()) && (myRoleId.toString() !== adminRoleId.toString())) {
                        ...
                        $('#curYearBcpmProposal').prop('readonly', true);
                    }
                    ...
                    if (evalFormulaId === 2) {
                        evalFormula = '(Baseline - Achievement)/(Baseline -Target) X weight';
                    }
                    if (evalFormulaId === '3') {
                        evalFormula = 'Other';
                    }
            ...
            success: function (res) {
                if (res.status === 1) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        let myRoleId = $('#myRoleId').val();
                        let creatorRoleId = $('#creatorRoleId').val();
                        let curYearBcpmProposalInput = '<input type="number" readonly id="curYearBcpmProposal' + i + '" class="form-control square field" value="' + data[i].curYearBcpmProposal + '" name="subTargetDtos[0].curYearBcpmProposal" autocomplete="off">';
                        ...
                        if (myRoleId !== creatorRoleId) {
                            ...
                            curYearBcpmProposalInput = '<input type="number" id="curYearBcpmProposal' + i + '" class="form-control square field" value="' + data[i].curYearBcpmProposal + '" name="subTargetDtos[0].curYearBcpmProposal" autocomplete="off">';
                        }
                        displayModeSubTarget = '<div class="row">' +
                            '<span class="subTargetId hidden">' + data[i].subTargetId + '</span> ' +
                            '<div class="col-md-10"><span>Sub Target:</span><strong class="subTarget"> ' + data[i].subTarget + '</strong></div>' +
                            '<div class="col-md-2"><span>Unit:</span> <strong>' + data[i].uom + '</strong></div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-4">' + preYear + ' Actual:<strong> ' + data[i].preYearActual + '</strong></div>' +
                            '<div class="col-md-4">' + preYear + ' Target:<strong> ' + data[i].preYearTarget + '</strong></div>' +
                            '<div class="col-md-4">' + curYear + ' Target:<strong> ' + data[i].preYearTarget + '</strong></div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-4">Weightage:<strong> ' + data[i].weightage + '</strong></div>' +
                            '<div class="col-md-4">' + curYear + ' DHI Proposal:<strong> ' + isNull(data[i].curYearBcpmProposal) + '</strong></div>' +
                            '<div class="col-md-2">' + attachments + '</div>' +
                            '<div class="col-md-2">' + readReviewerRemark +
                            '</div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-12">Explanation:<strong> ' + data[i].explanation + '</strong></div>' +
                            '</div>' +
                        ...
                        let editMode = '<tr><td>' +
                            '<div class="row">' +
                            '<div class="col-md-2">' +
                            '<label for="subTarget' + i + '" class="col-form-label required pull-right">Sub Target </label>' +
                            '</div>' +
                            ...
                            '</div>' +
                            '<div class="col-md-2"><label for="uom' + i + '" class="col-form-label required pull-right">Unit</label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group">' +
                            '<input type="text" id="uom' + i + '" class="form-control square field" value="' + data[i].uom + '" name="subTargetDtos[0].uom" required autocomplete="off">' +
                            '</div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-2"><label for="preYearActual' + i + '" class="col-form-label required pull-right">' +
                            '<span class="preYearActualLbl">' + preYear + '</span> Actual</label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group"><input type="number" id="preYearActual' + i + '" class="form-control square field"' +
                            'value="' + data[i].preYearActual + '" name="subTargetDtos[0].preYearActual" required autocomplete="off">' +
                            '</div>' +
                            '<div class="col-md-2">' +
                            '<label for="preYearTarget' + i + '" class="col-form-label required pull-right"><span class="preYearTargetLbl">' + preYear + '</span> Target</label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group">' +
                            '<input type="number" id="preYearTarget' + i + '" class="form-control square field" value="' + data[i].preYearTarget + '" name="subTargetDtos[0].preYearTarget" required autocomplete="off">' +
                            '</div>' +
                            '<div class="col-md-2">' +
                            '<label for="curYearTarget' + i + '" class="col-form-label required pull-right">' +
                            '<span class="curYearTargetLbl">' + curYear + '</span> Target </label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group">' +
                            '<input type="number" id="curYearTarget' + i + '" class="form-control square field" value="' + data[i].curYearTarget + '" name="subTargetDtos[0].curYearTarget" required autocomplete="off">' +
                            '</div></div>' +
                            '<div class="row">' +
                            '<div class="col-md-2">' +
                            ...
                            '<div class="row">' +
                            '<div class="col-md-2">' +
                            '<label for="explanation' + i + '" class="col-form-label pull-right">Explanation</label>' +
                            '</div>' +
                            '<div class="col-md-10 form-group">' +
                            '<textarea id="explanation' + i + '" class="form-control square field" name="subTargetDtos[0].explanation" autocomplete="off"' +
                            'onkeyup="textAreaAdjust(this)">' + data[i].explanation + '</textarea>' +
                            '</div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-2">' +
                            '<label for="curYearBcpmProposal' + i + '" class="col-form-label pull-right">' + curYear + ' DHI Proposal</label>' +
                            '</div>' +
                            '<div class="col-md-2 form-group">' + curYearBcpmProposalInput +
                            '</div>' +
                            '<div class="col-md-2 form-group">' +
                            '<button type="button" class="btn btn-danger btn-s square btnDeleteSubTarget"><i class="fa fa-trash"></i> Delete this target</button>' +
                            '</div>' +
                            '<div class="col-md-2">' + addEditReviewerRemark + '</div>' +
                            '</div> ' +
                            '<div class="dropdown-divider"></div>' +
                            '</td></tr>';
                        $('#subTargetTable tbody').append(editMode);
                    ...
                    let targetDetail = '<div class="row">' +
                        ...
                        '<div class="col-md-8"><span>Particular:</span> <strong>' + dayta.particular + '</strong></div>' +
                        '</div>';
    ...
    function checkPermission(year, companyId, statusFlag) {
        ...
        $.ajax({
            url: 'api/tfBcpmProdSaleList/checkPermission',
            type: 'GET',
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status === 1) {
                        ...
                        let curYear = data.year;
                        //display to read mode in history modal
                        let targetDetail = '<div class="row">' +
                            '<div class="col-md-4"><span>Serial No:</span> <strong>' + isNull(data.serialNo) + '</strong></div>' +
                            '<div class="col-md-8"><span>Particular:</span> <strong>' + data.particular + '</strong></div>' +
                            '</div>';
                        $('.targetDetailHistory').empty().html(targetDetail);
                        getSubTargetHistory(data.targetAuditId, curYear);
    ...
    function getSubTargetHistory(targetAuditId, curYear) {
        let preYear = curYear - 1;
        $.ajax({
                ...
                if (res.status === 1) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        displayModeSubTarget = displayModeSubTarget +
                            '<div class="row">' +
                            '<div class="col-md-12"><span>Sub Target:</span> <strong>' + data[i].subTarget + '</strong></divdiv>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-4"><span>' + preYear + ' Actual:</span> <strong>' + data[i].preYearActual + '</strong></div>' +
                            '<div class="col-md-4"><span>' + preYear + ' Target:</span> <strong>' + data[i].preYearTarget + '</strong></div>' +
                            '<div class="col-md-4"><span>' + curYear + ' Target:</span> <strong>' + data[i].curYearTarget + '</strong></div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-4"><span>Weightage:</span> <strong>' + data[i].weightage + '</strong></div>' +
                            '<div class="col-md-4"><span>Unit:</span> <strong>' + data[i].uom + '</strong></div>' +
                            '<div class="col-md-4"><span>' + curYear + ' DHI Proposal:</span> <strong>' + isNull(data[i].curYearBcpmProposal) + '</strong></div>' +
                            '</div>' +
                            '<div class="row">' +
                            '<div class="col-md-12"><span>Explanation:</span> <strong>' + data[i].explanation + '</strong></div>' +
                            '</div> ' +
                            '<div class="dropdown-divider"></div>' +
                            '</div>';
                    }
    ...
    function getPreData() {
        ...
        $.ajax({
            url: "api/tfBcpmProdSaleAddTarget/getTargetActivity",
            type: 'GET',
            success: function (res) {
                for (let i in res) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status === 1) {
                            ...
                            $('#comments').summernote('code', '', initEditor());
                            getComment();
                            isSubmitted = false;
                        } else {
                            $('.btnAddComment').attr("disabled", false);
    ...
    function getComment() {
        let targetId = $('#targetId').val();
        $.ajax({
            url: _baseURL() + 'getProdSaleComment',
            type: 'GET',
            data: {targetId: targetId},
            success: function (res) {
                if (res.status === 1) {
    ...
    function btnAddMore() {
        $('.btnAddMore').on('click', function () {
            ...
            let myRoleId = $('#myRoleId').val();
            let creatorRoleId = $('#creatorRoleId').val();
            let curYearBcpmProposalInput = '<input type="number" readonly id="curYearBcpmProposal' + dynamicId + '" class="form-control square field"  name="subTargetDtos[0].curYearBcpmProposal" autocomplete="off">';
            if (myRoleId.toString() !== creatorRoleId.toString()) {
                curYearBcpmProposalInput = '<input type="number" id="curYearBcpmProposal' + dynamicId + '" class="form-control square field" name="subTargetDtos[0].curYearBcpmProposal" autocomplete="off">';
            }
            let subTarget = '<tr><td>' +
                '<div class="row">' +
                '<div class="col-md-2">' +
                ...
                '<div class="row">' +
                '<div class="col-md-2">' +
                '<label for="curYearBcpmProposal' + dynamicId + '" class="col-form-label pull-right">' + curYear + ' DHI Proposal</label>' +
                '</div>' +
                '<div class="col-md-2 form-group">' + curYearBcpmProposalInput + '</div>' +
                '<div class="col-md-2 form-group">' +
                '<button type="button" class="btn btn-danger btn-s square btnDeleteSubTarget"><i class="fa fa-trash"></i> Delete this target</button>' +
                '</div>' +
                '</div>' +
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res.status === 1) {
                                            ...
                                            let targetId = $('#targetId').val();
                                            let newUrlIS = window.location.origin + '/tfBcpmProdSaleEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
    ...
    function getAllocatedWt(year, companyId) {
        $.ajax({
            url: 'api/tfBcpmProdSaleAddTarget/getAllocatedWt',
            type: "GET",
            data: {year: year, companyId: companyId},
            success: function (res) {
                if (res.status === 1) {
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
         tfBcpmProdSaleEditTarget.initEditor();
        tfBcpmProdSaleEditTarget.getTarget();
        tfBcpmProdSaleEditTarget.getPreData();
        tfBcpmProdSaleEditTarget.autoSuggest();
        tfBcpmProdSaleEditTarget.toggleLabel(year);
        tfBcpmProdSaleEditTarget.actionBtnEdit();
        tfBcpmProdSaleEditTarget.editTarget();
        tfBcpmProdSaleEditTarget.getAllocatedWt(year, companyId);
        tfBcpmProdSaleEditTarget.getAttachments();
        tfBcpmProdSaleEditTarget.deleteFile();
        tfBcpmProdSaleEditTarget.viewFile();
        tfBcpmProdSaleEditTarget.downloadFile();
        tfBcpmProdSaleEditTarget.remarkModalEditMode();
        tfBcpmProdSaleEditTarget.remarkModalDisplayMode();
        tfBcpmProdSaleEditTarget.addRemark();
        tfBcpmProdSaleEditTarget.editRemark();
        tfBcpmProdSaleEditTarget.addComment();
        tfBcpmProdSaleEditTarget.getComment();
        tfBcpmProdSaleEditTarget.closeOrReopenTarget();
        tfBcpmProdSaleEditTarget.btnAddMore();
        tfBcpmProdSaleEditTarget.deleteSubTarget();
        tfBcpmProdSaleEditTarget.deleteTarget();
        tfBcpmProdSaleEditTarget.getEditHistoryDetail();
        tfBcpmProdSaleEditTarget.checkCommentPolicy();
        tfBcpmProdSaleEditTarget.getCommentPolicy();
        tfBcpmProdSaleEditTarget.btnGoBack();
    });
