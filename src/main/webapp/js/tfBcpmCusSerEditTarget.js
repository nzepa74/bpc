tfBcpmCusSerEditTarget = (function () {
    "use strict";
    let form = $('#targetForm');
    ...
    function _baseURL() {
        return 'api/tfBcpmCusSerEditTarget/';
    }
    ...
    function checkPermission(year, companyId, statusFlag) {
        ...
        $.ajax({
            url: 'api/tfBcpmCusSerList/checkPermission',
            type: 'GET',
    ...
    function getPreData() {
        ...
        $.ajax({
            url: "api/tfBcpmCusSerAddTarget/getTargetActivity",
            type: 'GET',
            success: function (res) {
                for (let i in res) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        if (res.status === 1) {
                                            ...
                                            let targetId = $('#targetId').val();
                                            let newUrlIS = window.location.origin + '/tfBcpmCusSerEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
    ...
    function getAllocatedWt(year, companyId) {
        $.ajax({
            url: 'api/tfBcpmCusSerAddTarget/getAllocatedWt',
            type: "GET",
            data: {year: year, companyId: companyId},
            success: function (res) {
                if (res.status === 1) {
...
$(document).ready(
    function () {
        let year = $('#year').val();
        let companyId = $('#companyId').val();
        tfBcpmCusSerEditTarget.initEditor();
        tfBcpmCusSerEditTarget.getTarget();
        tfBcpmCusSerEditTarget.getPreData();
        tfBcpmCusSerEditTarget.autoSuggest();
        tfBcpmCusSerEditTarget.toggleLabel(year);
        tfBcpmCusSerEditTarget.actionBtnEdit();
        tfBcpmCusSerEditTarget.editTarget();
        tfBcpmCusSerEditTarget.getAllocatedWt(year, companyId);
        tfBcpmCusSerEditTarget.getAttachments();
        tfBcpmCusSerEditTarget.deleteFile();
        tfBcpmCusSerEditTarget.viewFile();
        tfBcpmCusSerEditTarget.downloadFile();
        tfBcpmCusSerEditTarget.remarkModalEditMode();
        tfBcpmCusSerEditTarget.remarkModalDisplayMode();
        tfBcpmCusSerEditTarget.addRemark();
        tfBcpmCusSerEditTarget.editRemark();
        tfBcpmCusSerEditTarget.addComment();
        tfBcpmCusSerEditTarget.getComment();
        tfBcpmCusSerEditTarget.closeOrReopenTarget();
        tfBcpmCusSerEditTarget.btnAddMore();
        tfBcpmCusSerEditTarget.deleteSubTarget();
        tfBcpmCusSerEditTarget.deleteTarget();
        tfBcpmCusSerEditTarget.getEditHistoryDetail();
        tfBcpmCusSerEditTarget.checkCommentPolicy();
        tfBcpmCusSerEditTarget.getCommentPolicy();
        tfBcpmCusSerEditTarget.btnGoBack();
    });
