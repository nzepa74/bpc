tfDhiOrgMgtList = (function () {
    "use strict";
    let form = $('#targetListForm');
    let isSubmitted = false;

    function _baseURL() {
        return 'api/tfDhiOrgMgtList/';
    }
    ...
    function navigateToTfDhiOrgMgtAddTarget() {
        $('.btnAddNewTarget').on('click', function () {
            let year = $('#year').val();
            let companyId = $('#companyId').val();
            window.location.href = 'tfDhiOrgMgtAddTarget?yId=' + year + '&&cId=' + companyId
        });
    }
    ...
    function navigateToEditTarget() {
        $('#targetListTable tbody').on('click', 'tr .activity', function () {
            ...
            window.location.href = 'tfDhiOrgMgtEditTarget?taId=' + targetAuditId + '&&tId=' + targetId
        });
    }
    ...
    function getComment() {
        $('#targetListTable tbody').on('click', 'tr .btnViewComment', function () {
            ...
            $('.targetNameDisplay').empty().html('<strong>' + targetName + ' </strong>');
            $.ajax({
                url: 'api/tfDhiOrgMgtEditTarget/getOrgMgtComment',
                type: 'GET',
    ...
    function getAttachment() {
        $('#targetListTable tbody').on('click', 'tr .btnAttachment', function () {
            ...
            $.ajax({
                url: 'api/tfDhiOrgMgtEditTarget/getAttachments',
                type: "GET",
    ...
    function viewFile() {
        $('.fileListDiv ul').on('click', 'li .viewFile', function () {
            ...
            let url = 'api/tfDhiOrgMgtEditTarget/viewFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    function downloadFile() {
        $('.fileListDiv ul').on('click', 'li span.fileName', function () {
            let fileId = $(this).closest('.fileUl .fileLi').find('.fileId').val();
            let url = 'api/tfDhiOrgMgtEditTarget/downloadFile/' + fileId;
            $.ajax({
                url: url,
                type: 'GET',
                data: {fileId: fileId},
    ...
    return {
        ...
        , navigateToTfDhiOrgMgtAddTarget: navigateToTfDhiOrgMgtAddTarget
        , btnSearch: btnSearch
...
$(document).ready(
    function () {
        tfDhiOrgMgtList.triggerSearch();
        tfDhiOrgMgtList.navigateToTfDhiOrgMgtAddTarget();
        tfDhiOrgMgtList.btnSearch();
        tfDhiOrgMgtList.searchByStage();
        tfDhiOrgMgtList.navigateToEditTarget();
        tfDhiOrgMgtList.getWriteup();
        tfDhiOrgMgtList.getComment();
        tfDhiOrgMgtList.getAttachment();
        tfDhiOrgMgtList.viewFile();
        tfDhiOrgMgtList.downloadFile();
        tfDhiOrgMgtList.submit();
        tfDhiOrgMgtList.revert();
        tfDhiOrgMgtList.approve();
        tfDhiOrgMgtList.btnGoBack();
    });
