...
@Getter
@Entity
@Table(name = "tf_bcpm_cus_ser_target_writeup_a")
public class TfBcpmCusSerTargetWriteup_a extends BaseEntity {
    ...
    @Column(name = "isProratable", columnDefinition = "char(1)")
