 ...
 */
public interface TfBcpmCusSerTargetWriteupRepository extends JpaRepository<TfBcpmCusSerTargetWriteup, String> {
    TfBcpmCusSerTargetWriteup findByTargetId(String targetId);
}
