 ...
 */
@Repository
public class TfBcpmOrgMgtEditTargetDao extends BaseDao {
    private final Environment environment;

    public TfBcpmOrgMgtEditTargetDao(Environment environment) {
        this.environment = environment;
    }

    @Transactional
    public OrgMgtTargetDto getTarget(String targetAuditId) {
        String sql = environment.getProperty("TfBcpmOrgMgtEditTargetDao.getTarget");
        try {
    ...
    public List<OrgMgtSubTargetDto> getSubTarget(String targetAuditId) {
        String sqlQuery = environment.getProperty("TfBcpmOrgMgtEditTargetDao.getSubTarget");
    ...
    public List<EditHistoryDto> getTargetEditHistory(String targetId) {
        String sqlQuery = environment.getProperty("TfBcpmOrgMgtEditTargetDao.getTargetEditHistory");
    ...
    public List<TargetStatusDto> getTargetStatus(String targetId) {
        String sqlQuery = environment.getProperty("TfBcpmOrgMgtEditTargetDao.getTargetStatus");
    ...
    public BigInteger getTargetVersionNo(String targetId) {
        String sqlQuery = environment.getProperty("TfBcpmOrgMgtEditTargetDao.getTargetVersionNo");
