 ...
 */
@Repository
public class TfDhiFinEditTargetDao extends BaseDao {
    private final Environment environment;

    public TfDhiFinEditTargetDao(Environment environment) {
        this.environment = environment;
    }

    @Transactional
    public FinancialTargetDto getTarget(String targetAuditId) {
        String sql = environment.getProperty("TfDhiFinEditTargetDao.getTarget");
        try {
    ...
    public List<EditHistoryDto> getTargetEditHistory(String targetId) {
        String sqlQuery = environment.getProperty("TfDhiFinEditTargetDao.getTargetEditHistory");
    ...
    public List<TargetStatusDto> getTargetStatus(String targetId) {
        String sqlQuery = environment.getProperty("TfDhiFinEditTargetDao.getTargetStatus");
    ...
    public BigInteger getTargetVersionNo(String targetId) {
        String sqlQuery = environment.getProperty("TfDhiFinEditTargetDao.getTargetVersionNo");
